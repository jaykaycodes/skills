...
Invoke /ui build — it contains design principles, anti-patterns, and the **Context Gathering Protocol**. Follow the protocol before proceeding — if no design context exists yet, you MUST run /ui teach first. Additionally gather: target platforms/devices and usage contexts.
