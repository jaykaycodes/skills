...
Invoke /ui build, which contains design principles, anti-patterns, and the **Context Gathering Protocol**. Follow the protocol before proceeding. If no design context exists yet, you MUST run /ui teach first. Additionally gather: what the interface is trying to accomplish.
...
- **Suggested command**: Which command could address this (from: /ui tune motion, /ui polish, /ui shape, /ui tune performance, /ui tune responsive, /ui polish, /ui tune layout, /ui polish, /ui polish, /ui review, /ui tune hardening, /ui polish, /ui polish, /ui tune type, /ui review, /ui tune color, /ui polish)
...
2. **Design intent**: If the critique found a tonal mismatch, ask whether it was intentional. For example: "The interface feels clinical and corporate. Is that the intended tone, or should it feel warmer/ui polish/more playful?" Offer 2-3 tonal directions as options based on what would fix the issues found.
...
- Only recommend commands from: /ui tune motion, /ui polish, /ui shape, /ui tune performance, /ui tune responsive, /ui polish, /ui tune layout, /ui polish, /ui polish, /ui review, /ui tune hardening, /ui polish, /ui polish, /ui tune type, /ui review, /ui tune color, /ui polish
...
- End with `/ui polish` as the final step if any fixes were recommended

After presenting the summary, tell the user:

> You can ask me to run these one at a time, all at once, or in any order you prefer.
>
> Re-run `/ui review` after fixes to see your score improve.